// Production-ready server with Zyte integration
  ...
  try {
    ...
    if (urlLower.includes('tacoma')) {
      ...
      carData = {
        ...
        description: 'Well-maintained vehicle with good features.',
        source: 'Zyte API'
      };
    }
...
app.listen(PORT, () => {
  console.log(`🚀 DealAnalyzer Production Server running on port ${PORT}`);
